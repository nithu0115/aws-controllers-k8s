...
import (
	throttle "github.com/aws/aws-controllers-k8s/pkg/throttle"
...
func (_m *AWSResourceManagerFactory) ManagerFor(_a0 v1alpha1.AWSAccountID, _a1 *throttle.ServiceOperationsThrottleConfig) (types.AWSResourceManager, error) {
	ret := _m.Called(_a0, _a1)

	var r0 types.AWSResourceManager
	if rf, ok := ret.Get(0).(func(v1alpha1.AWSAccountID, *throttle.ServiceOperationsThrottleConfig) types.AWSResourceManager); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(v1alpha1.AWSAccountID, *throttle.ServiceOperationsThrottleConfig) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
